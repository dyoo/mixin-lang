...
;                  [info #,~info])
;             (if (or (not info) (and (procedure? info) (procedure-arity-includes? info 3)))
;                 info
...
;          [(procedure-arity-includes? lang 5) lang]
;          [(procedure-arity-includes? lang 1) (lambda (in . _) (lang in))]
;          [(procedure-arity-includes? lang 0) (lambda _ (lang))]
